...
import static seedu.address.logic.parser.ParserUtilPrescription.MESSAGE_INVALID_INDEX;
...
public class ParserUtilPrescriptionTest {
    ...
    public void parseIndex_invalidInput_throwsParseException() {
        assertThrows(ParseException.class, () -> ParserUtilPrescription.parseIndex("10 a"));
    }

    @Test
    public void parseIndex_outOfRangeInput_throwsParseException() {
        assertThrows(ParseException.class, MESSAGE_INVALID_INDEX, ()
            -> ParserUtilPrescription.parseIndex(Long.toString(Integer.MAX_VALUE + 1)));
    }

    @Test
    public void parseIndex_validInput_success() throws Exception {
        // No whitespaces
        assertEquals(INDEX_FIRST_PRESCRIPTION, ParserUtilPrescription.parseIndex("1"));
    ...
    public void parseName_null_throwsNullPointerException() {
        assertThrows(NullPointerException.class, () -> ParserUtilPrescription.parseName((String) null));
    }

    @Test
    public void parseName_invalidValue_throwsParseException() {
        assertThrows(ParseException.class, () -> ParserUtilPrescription.parseName(INVALID_NAME));
    }

    @Test
    public void parseName_validValueWithoutWhitespace_returnsName() throws Exception {
        Name expectedName = new Name(VALID_NAME);
        assertEquals(expectedName, ParserUtilPrescription.parseName(VALID_NAME));
    }
    ...
    public void parseName_validValueWithWhitespace_returnsTrimmedName() throws Exception {
        ...
        Name expectedName = new Name(VALID_NAME);
        assertEquals(expectedName, ParserUtilPrescription.parseName(nameWithWhitespace));
    }

    @Test
    public void parseDosage_null_throwsNullPointerException() {
        assertThrows(NullPointerException.class, () -> ParserUtilPrescription.parseDosage((String) null));
    }

    @Test
    public void parseDosage_invalidValue_throwsParseException() {
        assertThrows(ParseException.class, () -> ParserUtilPrescription.parseDosage(INVALID_DOSAGE));
    }
    ...
    public void parseDosage_validValueWithoutWhitespace_returnsDosage() throws Exception {
        ...
        assertEquals(expectedDosage, ParserUtilPrescription.parseDosage(VALID_DOSAGE));
    }
    ...
    public void parseDosage_validValueWithWhitespace_returnsTrimmedDosage() throws Exception {
        ...
        Dosage expectedDosage = new Dosage(VALID_DOSAGE);
        assertEquals(expectedDosage, ParserUtilPrescription.parseDosage(dosageWithWhitespace));
    }

    @Test
    public void parseFrequency_null_throwsNullPointerException() {
        assertThrows(NullPointerException.class, () -> ParserUtilPrescription.parseFrequency((String) null));
    }

    @Test
    public void parseFrequency_invalidValue_throwsParseException() {
        assertThrows(ParseException.class, () -> ParserUtilPrescription.parseFrequency(INVALID_FREQUENCY));
    }
    ...
    public void parseFrequency_validValueWithoutWhitespace_returnsFrequency() throws Exception {
        ...
        assertEquals(expectedFrequency, ParserUtilPrescription.parseFrequency(VALID_FREQUENCY));
    }
    ...
    public void parseFrequency_validValueWithWhitespace_returnsTrimmedFrequency() throws Exception {
        ...
        Frequency expectedFrequency = new Frequency(VALID_FREQUENCY);
        assertEquals(expectedFrequency, ParserUtilPrescription.parseFrequency(frequencyWithWhitespace));
    }

    @Test
    public void parseStartDate_null_throwsNullPointerException() {
        assertThrows(NullPointerException.class, () -> ParserUtilPrescription.parseStartDate((String) null));
    }

    @Test
    public void parseStartDate_invalidValue_throwsParseException() {
        assertThrows(ParseException.class, () -> ParserUtilPrescription.parseStartDate(INVALID_START_DATE));
    }
    ...
    public void parseStartDate_validValueWithoutWhitespace_returnsStartDate() throws Exception {
        ...
        assertEquals(expectedStartDate, ParserUtilPrescription.parseStartDate(VALID_START_DATE));
    }
    ...
    public void parseStartDate_validValueWithWhitespace_returnsTrimmedStartDate() throws Exception {
        ...
        Date expectedStartDate = new Date(VALID_START_DATE);
        assertEquals(expectedStartDate, ParserUtilPrescription.parseStartDate(startDateWithWhitespace));
    }

    @Test
    public void parseEndDate_null_throwsNullPointerException() {
        assertThrows(NullPointerException.class, () -> ParserUtilPrescription.parseEndDate((String) null));
    }

    @Test
    public void parseEndDate_invalidValue_throwsParseException() {
        assertThrows(ParseException.class, () -> ParserUtilPrescription.parseEndDate(INVALID_END_DATE));
    }
    ...
    public void parseEndDate_validValueWithoutWhitespace_returnsEndDate() throws Exception {
        ...
        assertEquals(expectedEndDate, ParserUtilPrescription.parseEndDate(VALID_END_DATE));
    }
    ...
    public void parseEndDate_validValueWithWhitespace_returnsTrimmedEndDate() throws Exception {
        ...
        Date expectedEndDate = new Date(VALID_END_DATE);
        assertEquals(expectedEndDate, ParserUtilPrescription.parseEndDate(endDateWithWhitespace));
    }

    @Test
    public void parseExpiryDate_null_throwsNullPointerException() {
        assertThrows(NullPointerException.class, () -> ParserUtilPrescription.parseExpiryDate((String) null));
    }

    @Test
    public void parseExpiryDate_invalidValue_throwsParseException() {
        assertThrows(ParseException.class, () -> ParserUtilPrescription.parseExpiryDate(INVALID_EXPIRY_DATE));
    }
    ...
    public void parseExpiryDate_validValueWithoutWhitespace_returnsExpiryDate() throws Exception {
        ...
        assertEquals(expectedExpiryDate, ParserUtilPrescription.parseExpiryDate(VALID_EXPIRY_DATE));
    }
    ...
    public void parseExpiryDate_validValueWithWhitespace_returnsTrimmedExpiryDate() throws Exception {
        ...
        Date expectedExpiryDate = new Date(VALID_EXPIRY_DATE);
        assertEquals(expectedExpiryDate, ParserUtilPrescription.parseExpiryDate(expiryDateWithWhitespace));
    }

    @Test
    public void parseTotalStock_null_throwsNullPointerException() {
        assertThrows(NullPointerException.class, () -> ParserUtilPrescription.parseTotalStock((String) null));
    }

    @Test
    public void parseTotalStock_invalidValue_throwsParseException() {
        assertThrows(ParseException.class, () -> ParserUtilPrescription.parseTotalStock(INVALID_TOTAL_STOCK));
    }
    ...
    public void parseTotalStock_validValueWithoutWhitespace_returnsTotalStock() throws Exception {
        ...
        assertEquals(expectedTotalStock, ParserUtilPrescription.parseTotalStock(VALID_TOTAL_STOCK));
    }
    ...
    public void parseTotalStock_validValueWithWhitespace_returnsTrimmedTotalStock() throws Exception {
        ...
        Stock expectedTotalStock = new Stock(VALID_TOTAL_STOCK);
        assertEquals(expectedTotalStock, ParserUtilPrescription.parseTotalStock(totalStockWithWhitespace));
    }

    @Test
    public void parseNote_null_throwsNullPointerException() {
        assertThrows(NullPointerException.class, () -> ParserUtilPrescription.parseNote((String) null));
    }

    @Test
    public void parseNote_invalidValue_throwsParseException() {
        assertThrows(ParseException.class, () -> ParserUtilPrescription.parseNote(INVALID_NOTE));
    }

    @Test
    public void parseNote_validValueWithoutWhitespace_returnsNote() throws Exception {
        Note expectedNote = new Note(VALID_NOTE);
        assertEquals(expectedNote, ParserUtilPrescription.parseNote(VALID_NOTE));
    }
    ...
    public void parseNote_validValueWithWhitespace_returnsTrimmedNote() throws Exception {
        ...
        Note expectedNote = new Note(VALID_NOTE);
        assertEquals(expectedNote, ParserUtilPrescription.parseNote(noteWithWhitespace));
    }
...
//        assertThrows(ParseException.class, () -> ParserUtilPrescription.parseTags(Arrays.asList(VALID_TAG_1, INVALID_TAG)));
//    }
//
//    @Test
