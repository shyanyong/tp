...
/**
 * Finds and lists all prescriptions in address book whose name contains any of the argument keywords.
...
public class FindCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Finds all prescriptions whose names contain any of "
