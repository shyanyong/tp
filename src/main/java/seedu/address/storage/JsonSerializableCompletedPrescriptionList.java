...
class JsonSerializableCompletedPrescriptionList {
     ...
     */
    @JsonCreator
    public JsonSerializableCompletedPrescriptionList(
            @JsonProperty("completedPrescriptions") List<JsonAdaptedPrescription> prescriptions) {
     ...
     */
    public JsonSerializableCompletedPrescriptionList(ReadOnlyPrescriptionList source) {
